...
const Card = ({
  ...
  return (
    <div
      ...
      className="group/canvas-card relative flex justify-center items-center mx-auto p-4 border border-black/[0.2] dark:border-white/[0.2] rounded-3xl w-full max-w-sm lg:h-[35rem]"
      style={{
        //   add these two
    ...
    >
      ...
      <div className="z-20 relative px-10">
        ...
        <h2
          ...
          className="z-10 relative opacity-0 group-hover/canvas-card:opacity-100 mt-4 font-bold text-black dark:text-white group-hover/canvas-card:text-white text-3xl text-center transition group-hover/canvas-card:-translate-y-2 duration-200"
        >
          {title}
        </h2>
        {/* add this one for the description */}
        <p
          className="z-10 relative opacity-0 group-hover/canvas-card:opacity-100 mt-4 group-hover/canvas-card:text-white text-sm text-center transition group-hover/canvas-card:-translate-y-2 duration-200"
          style={{ color: "#E4ECFF" }}
        >
          {des}
        </p>
  ...
  return (
    <div>
      ...
      <button className="inline-flex relative p-[1px] rounded-full overflow-hidden">
        ...
        <span className="inline-flex justify-center items-center bg-slate-950 backdrop-blur-3xl px-5 py-2 rounded-full w-full h-full font-bold text-purple text-2xl cursor-pointer">
          {order}
        </span>
      </button>
    </div>
